...
public class Trending7DaysMoviesResponse {
    ...
    public Trending7DaysMoviesResponse(Integer page, Integer totalResults, Integer totalPages, List<MovieBrief> results) {
        this.page = page;
