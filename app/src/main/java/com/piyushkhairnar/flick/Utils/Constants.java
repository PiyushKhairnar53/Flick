...
public class Constants {
    ...
    public static final String TRENDING_MOVIES = "trending_movies";
    public static final int TRENDING_MOVIES_TODAY = 1;
    public static final int TRENDING_MOVIES_7DAYS = 2;

    public static final String TRENDING_SHOWS = "trending_shows";
    public static final int TRENDING_SHOWS_TODAY = 1;
    public static final int TRENDING_SHOWS_7DAYS = 2;
