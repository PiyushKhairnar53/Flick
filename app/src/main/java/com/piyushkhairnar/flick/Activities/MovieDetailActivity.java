...
import com.piyushkhairnar.flick.Adapters.MovieCastsAdapter;
import com.piyushkhairnar.flick.Adapters.VideoAdapter;
...
import com.piyushkhairnar.flick.network.movies.Genre;
import com.piyushkhairnar.flick.network.movies.Movie;
import com.piyushkhairnar.flick.network.movies.MovieBrief;
import com.piyushkhairnar.flick.network.movies.MovieCastBrief;
...
import com.piyushkhairnar.flick.network.videos.Video;
...
public class MovieDetailActivity extends AppCompatActivity {
    ...
    private void setImageButtons(final Integer movieId, final String posterPath, final String movieTitle, final String movieTagline, final String imdbId, final String homepage) {
        ...
        if (Favourite.isMovieFav(MovieDetailActivity.this, movieId)) {
            ...
            mFavImageButton.setImageResource(R.drawable.ic_favorite_red);
        } else {
            mFavImageButton.setTag(Constants.TAG_NOT_FAV);
            mFavImageButton.setImageResource(R.drawable.ic_favorite_border_black_24dp);
        }
